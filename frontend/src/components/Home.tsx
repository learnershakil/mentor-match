  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E6C7E6] to-[#663399] flex items-center justify-center p-4">
      <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-md p-8 border border-[#A3779D]/30">
        <h1 className="text-3xl font-bold text-[#2E1A47] text-center mb-2">Mentor&apos;s Match</h1>
        ...
        <div className="mb-6">
          <label htmlFor="room-id" className="block text-sm font-medium text-[#2E1A47] mb-1">Session ID</label>
          <input
            id="room-id"
            type="text"
